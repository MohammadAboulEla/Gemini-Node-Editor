...
export const PaddingNode: React.FC<NodeContentProps> = ({ node, updateNodeData }) => {
    const { 
        aspectRatio = '1:1', 
        direction = 'center', 
        color = '#000000',
    ...
    return (
        <div className="p-2 space-y-3">
             <div className="w-full text-center p-1.5 bg-slate-900 rounded-md">
                {status === 'loading' && <p className="text-xs text-cyan-400">Processing...</p>}
            ...
            <div>
                <label className="text-xs font-semibold text-slate-400 block mb-1">Padding Color</label>
            ...
            <div>
                <label className="text-xs font-semibold text-slate-400 block mb-1">Target Aspect Ratio</label>
                <select
                    value={aspectRatio}
            ...
            <div>
                <label className="text-xs font-semibold text-slate-400 block mb-1">Align Image</label>
                <select
                    value={direction}
