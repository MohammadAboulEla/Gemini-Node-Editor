    ...
    return (
        <div className="p-2 h-full flex flex-col gap-2">
            ...
            {hasText && (
                ...
                >
                    <p className={`${!hasImage ? 'text-base' : 'text-xs'} h-full text-slate-300 p-2 bg-slate-900 rounded overflow-y-auto whitespace-pre-wrap break-words border border-slate-700 pr-10`}>
                        {text}
                    </p>
                    <button
                        onClick={handleCopy}
